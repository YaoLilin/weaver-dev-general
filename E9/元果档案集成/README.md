...
请查看开发包内的说明文档进行部署。 
由于文件上传限制，开发包内没有包含字体包，字体包需要到此仓库获取：[weaver-e9-pde-archive: 泛微 E9 集成量子档案开发，使用配置化开发 ，可对不同流程配置档案推送](https://gitee.com/yaolilin/weaver-e9-pde-archive)

## 开发包

[20240920-柳钢档案推送-姚礼林.zip](files/20240920-柳钢档案推送-姚礼林.zip)